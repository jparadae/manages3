...
class UserProfile(models.Model):
    ...
    rut = models.CharField(max_length=200,blank=True)
    registrado = models.BooleanField(max_length=None,blank=True, null=True)
    backend = models.BooleanField(max_length=None,blank=True)
    frontend = models.BooleanField(max_length=None,blank=True)
